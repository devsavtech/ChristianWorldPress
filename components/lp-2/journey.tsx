        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 text-center lg:text-left">
            <h2 className="text-3xl md:text-4xl font-bold text-black leading-tight">
              Your Book Publishing Journey Starts with Kinetic Digital Publishers
            </h2>
            <div className="space-y-4 text-gray-700">
              <p>
                Kinetic Digital Publishers was built for authors who want more than just a finished book. We help writers turn their ideas into professional work. We offer everything under one roof. Our team works closely with authors at every stage of their journey. Some come to us with a final draft. Others come with a clear vision and need the right executive if that's basic, our focus stays the same. Careful planning, Professional production. Full support that actually moves the book forward.
              </p>
              <p>
                We believe good publishing is a balance of craft and strategy. That's how we help authors reach readers worldwide.
              </p>
            </div>
