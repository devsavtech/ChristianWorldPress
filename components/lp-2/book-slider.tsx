    ...
    <section className="bg-[#f5f5f5] py-20 relative overflow-hidden">
      ...
      <div className="text-center mb-16 px-6">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-[2.6rem] font-bold text-gray-900 mb-5 leading-tight font-serif max-w-3xl mx-auto">
          Books Published for Authors Across the United States
        </h2>
        <p className="text-gray-500 text-sm md:text-[0.95rem] max-w-2xl mx-auto leading-relaxed">
          Our portfolio reflects the work we've done with authors from different backgrounds and
          genres. As a provider of book publishing services USA, each project represents a
          collaboration focused on preparing manuscripts for professional publication and
          connecting stories with readers through online book publishing platforms.
        </p>
      </div>
