...
export function Experience() {
  const {displayedText, isTyping, sectionRef} = useTypingAnimation("Ready to Share Your Message as a Christian Author?")
  return (
...
Your book has the power to encourage, inspire, and reach lives. Let Christian World Press help you take the next step with clear guidance and a simple publishing process.             </p>
          </div>
