...
export function BookSlider() {
  ...
  return (
    <section className="bg-[#f5f5f5] py-20 relative overflow-hidden">
      ...
      {/* CTA Buttons */}
      <div className="flex flex-col sm:flex-row gap-4 justify-center mt-18 px-6">
        <ClassicButton
        variant="primary"
        icon={BookOpen}
          onClick={() => setShowPopup(true)}
          className="bg-[#8b0000] hover:bg-[#6b0000] text-white rounded-sm uppercase font-bold tracking-widest px-12 py-6 text-sm w-full sm:w-auto popup_button"
        >
          Publish Your Book
        </ClassicButton>
        ...
        <ClassicButton
          ...
          variant="outline"
          icon={MessageCircle}
          className="text-black border-2 border-black hover:bg-black hover:text-white rounded-sm uppercase font-bold tracking-widest px-12 py-6 text-sm w-full sm:w-auto chat_button"
        >
          Live Chat
        </ClassicButton>
      </div>
